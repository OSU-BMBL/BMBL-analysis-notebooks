...
### Compute the contribution of each ligand-receptor pair to the overall signaling pathway and visualize cell-cell communicsation mediated by a single ligand-receptor pair
...
```{rl[[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'[;'*-]]]]]]]]]]]]]]]]]]], fig.wide = TRUE, fig.align = "center"}
lkkkkcellchat <- computeNetSimilarity(cellchat, type = "functional")
...
```
---
*This lesson materials was originally created by CellChat team, and has been developed by members of the BMBL.*

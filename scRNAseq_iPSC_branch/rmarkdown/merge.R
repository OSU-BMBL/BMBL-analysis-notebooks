...
obj1 <- qs::qread(paste0("./Control Day5_cell_type.qsave"))
obj2 <- qs::qread(paste0("./Control Day8_cell_type.qsave"))
obj3 <- qs::qread(paste0("./Control Day10_cell_type.qsave"))
obj4 <- qs::qread(paste0("./Control Day14_cell_type.qsave"))
obj5 <- qs::qread(paste0("./HG Day5_cell_type.qsave"))
obj6 <- qs::qread(paste0("./HG Day8_cell_type.qsave"))
obj7 <- qs::qread(paste0("./HG Day10_cell_type.qsave"))
obj8 <- qs::qread(paste0("./HG Day14_cell_type.qsave"))

combined <- merge(obj1, y=c(obj2, obj3, obj4, obj5, obj6, obj7, obj8))

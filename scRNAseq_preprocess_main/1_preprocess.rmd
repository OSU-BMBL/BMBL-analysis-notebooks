...
combine.anchors <-
  FindIntegrationAnchors(object.list = combine.list, dims = 1:15)
combined_qc <- IntegrateData(anchorset = combine.anchors, dims = 1:15)
...
combined_qc <- RunUMAP(combined_qc, reduction = "pca", dims = 1:15, verbose = FALSE)
combined_qc <- FindNeighbors(combined_qc, reduction = "pca", dims = 1:15, verbose = FALSE)
